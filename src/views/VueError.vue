<template>
  <div
    class="height-min-100 width-full background-secondary colored-text-secondary centered"
  >
    <div class="boxed pop">
      <h1>I'm really sorry!</h1>

      <p>
        I was working on the website but dolor sit amet, consectetur adipiscing
      ...
      <hr />
      <h3>
        The excuse doesn't matter, this shouldn't have happened, please let me
        know a little more and we can make this right.
      </h3>

      <p>For now, <a href="/">let's head back home</a></p>
    </div>
  </div>
</template>
...
<!-- Attempting Hack for Vue Router. Add script to 404.html to collect desired route. Checked on BaseView and if exists pushes. -->
